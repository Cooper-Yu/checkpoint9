...
- `straight_sample_count`: cart-frame samples per service detection attempt. Default: `7`.
- `straight_sample_max_spread`: tolerated cart-frame inlier spread during service detection. Default: `0.25`.
